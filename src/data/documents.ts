...
Serra Azul/SP, data. Promotor de Justiça`
  },
  {
    id: "crime-2",
    category: "Crime",
    title: "2. Denúncia (Crime Comum)",
    content: `EXCELENTÍSSIMO SENHOR DOUTOR JUIZ DE DIREITO DA VARA CRIMINAL DA COMARCA.
Autos de Inquérito Policial.

O MINISTÉRIO PÚBLICO DO ESTADO, pelo Promotor de Justiça em exercício nesta Promotoria, nos termos do artigo 129, inciso I, da Constituição Federal, vem, à presença de Vossa Excelência, oferecer DENÚNCIA, em face do Denunciado, pelas condutas delituosas a seguir.

1 - DOS FATOS
Consta dos inclusos autos de inquérito policial que, no dia 02 de fevereiro de 2023, às 19 horas, na Rua, o Denunciado, agindo de forma livre, consciente e com intenção de matar, matou a vítima, ao desferir contra ela disparos de arma de fogo que causaram-lhe as lesões acostadas no laudo cadavérico, que foram suficientes para sua morte, agindo por motivo torpe e valendo-se de recurso que impossibilitou a defesa da vítima.

2 - DA NARRATIVA FÁTICA
O crime foi praticado por motivo torpe, consistente em se vingar do sujeito passivo. O delito, ainda, foi cometido com recurso que impossibilitou a defesa da vítima, pois esta foi colhida de modo súbito, sem ter qualquer condição de esboçar alguma reação.

3 - DA CONCLUSÃO
Ante o exposto, o Ministério Público DENUNCIA o acusado como incurso no artigo 121, parágrafo 2º, incisos II e IV do Código Penal. Requer-se a observância do rito processual, o recebimento da denúncia, a citação do Denunciado para apresentar resposta à acusação, e ao final, a pronúncia e posterior condenação pelo Tribunal do Júri, com a fixação de valor mínimo a título de ressarcimento do dano à vítima.`
  },
  {
    id: "crime-3",
    category: "Crime",
    title: "3. Denúncia (Rito Júri)",
    content: `EXCELENTÍSSIMO SENHOR DOUTOR JUIZ DE DIREITO DA VARA DO JÚRI DA COMARCA DE SANTA HELENA, SÃO PAULO.

O MINISTÉRIO PÚBLICO DO ESTADO DE SÃO PAULO, por seu Promotor de Justiça infra-assinado, vem, respeitosamente, à presença de Vossa Excelência, oferecer DENÚNCIA contra JOÃO SILVA, pela prática do crime descrito nos termos que seguem:

Consta do incluso inquérito policial que, no dia 02 de março de 2022, por volta das 20 horas, na residência localizada na Rua das Palmeiras, o denunciado JOÃO SILVA, agindo com intenção de matar, por motivo fútil, com emprego de meio cruel e de recurso que dificultou a defesa da vítima, tentou matar FELIPE SILVA, seu primo, mediante múltiplos golpes com faca do tipo açougueiro, atingindo-o em diversas partes vitais do corpo, somente não consumando o homicídio por circunstâncias alheias à sua vontade, notadamente o socorro médico prestado.

Durante confraternização familiar em sua residência, após consumo de bebidas alcoólicas, o denunciado e a vítima iniciaram desentendimento. Apesar da intervenção das testemunhas, o denunciado desferiu cerca de doze facadas contra a vítima. Após a brutal agressão, JOÃO SILVA evadiu-se do local, trancando o portão e impedindo o imediato socorro à vítima.

O crime foi praticado por motivo fútil, pois decorreu de discussão banal. Houve emprego de meio cruel, evidenciando intenção deliberada de provocar sofrimento físico extremo. Utilizou ainda recurso que dificultou a defesa da vítima, surpreendendo-a no contexto de confraternização.

Diante do exposto, o MINISTÉRIO PÚBLICO oferece DENÚNCIA contra JOÃO SILVA pela prática do crime previsto no artigo 121, parágrafo 2º, incisos II, III e IV, combinado com o artigo 14, inciso II, ambos do Código Penal. Requer seja instaurado o devido processo penal, observando-se o rito estabelecido nos artigos 406 e seguintes do Código de Processo Penal.`
  },
  {
    id: "crime-4",
    category: "Crime",
    title: "4. Cota Ministerial",
    content: `COTA DE OFERECIMENTO DA DENÚNCIA
Autos de Inquérito Policial.

Meritíssimo Juiz,

1) Oferecida denúncia em separado;
2) Requer-se remessa para o juízo competente;
3) Requer-se a juntada de folha de antecedentes criminais e certidões;
4) Deixa-se de oferecer a proposta de transação penal e suspensão condicional do processo, porquanto não se aplicam na hipótese de delitos sujeitos ao rito da Lei Maria da Penha, conforme entendimento sumulado do STJ.
5) Deixa-se de oferecer acordo de não persecução penal, visto que não preenche os requisitos legais.

Requer-se, como efeito extrapenal específico da condenação, seja decretada a perda do cargo público ou função pública.

Presentes os pressupostos de admissibilidade, requer-se a decretação da prisão preventiva, pois necessária como garantia da ordem pública e para conveniência da instrução criminal, havendo prova da existência do crime e indício suficiente de autoria, bem como de perigo gerado pelo estado de liberdade do imputado. Sendo insuficientes outras medidas cautelares diversas da prisão.

Requer-se a concessão de medidas protetivas em desfavor do Denunciado, nos termos da Lei Maria da Penha, e a apreensão da arma de fogo sob sua posse.
...
Promotor de Justiça.`
  },
  {
    id: "crime-5",
    category: "Crime",
    title: "5. Alegações Finais por Memoriais Escritos",
    content: `AO JUÍZO DA VARA CRIMINAL DA COMARCA.
Autos número.
AUTOR: Ministério Público.
RÉU: Nome.

O MINISTÉRIO PÚBLICO, pelo Promotor de Justiça em exercício, vem apresentar ALEGAÇÕES FINAIS POR MEMORIAL.

1 – DO RELATÓRIO
Trata-se de ação penal promovida pelo Ministério Público em face do Réu. A denúncia foi recebida, a instrução realizada com oitiva de vítima, testemunhas e interrogatório do réu. Encerrada a instrução, os autos vieram para alegações finais.

2 – DAS PRELIMINARES DE MÉRITO
Inicialmente, cumpre destacar que o presente feito foi instaurado e se desenvolveu regular e validamente, não existindo qualquer nulidade a ser sanada, estando pronto para julgamento.

3 – DO MÉRITO
A materialidade delitiva restou devidamente comprovada em razão dos laudos e exames, aliados aos depoimentos colhidos na instrução criminal. Ademais, a autoria é certa e segura ante as provas carreadas nos autos. As testemunhas afirmaram os fatos, e o próprio Réu confessou em seu interrogatório. A tese defensiva de negativa de autoria não merece acolhida, porquanto as provas são suficientes em apontar que o réu praticou o delito.

4 – DA PENA
Em relação à reprimenda, a pena-base deve ser fixada acima do mínimo legal devido às circunstâncias judiciais desfavoráveis. Na segunda fase, presente a agravante da reincidência, a pena deve ser aumentada. Incabível a substituição da pena privativa de liberdade por restritiva de direitos. O Réu deve iniciar o cumprimento da pena em regime fechado. Por fim, deve ser mantida a prisão preventiva, pois persistem os requisitos para sua decretação.

5 – DOS PEDIDOS
Ante o exposto, o Ministério Público requer a procedência da ação com a CONDENAÇÃO do réu, nos termos expostos, bem como seja mantida a prisão preventiva e negado o direito de recorrer em liberdade.
...
Promotor de Justiça.`
  },
  {
    id: "crime-6",
    category: "Crime",
    title: "6. Alegações Finais por Memoriais (Rito do Júri – Fase da Pronúncia)",
    content: `AO JUÍZO DO TRIBUNAL DO JÚRI DA COMARCA.
Autos número.
AUTOR: Ministério Público.
RÉU: Nome.
...
1 – DO RELATÓRIO
Trata-se de ação penal promovida pelo Ministério Público em face do Réu. Encerrada a instrução, os autos vieram para alegações finais.

2 – DAS PRELIMINARES DE MÉRITO
O feito desenvolveu-se regular e validamente, não existindo nulidade a ser sanada.

3 – DO MÉRITO
A materialidade delitiva restou devidamente comprovada. As provas produzidas em Juízo colocam o Réu no cenário do crime, indicando-o como o Autor. Ressalta-se que a pronúncia do Réu para o julgamento pelo Tribunal do Júri não exige a existência de prova cabal da autoria do delito, sendo suficiente, nessa fase processual, a mera existência de indícios da autoria, pois a pronúncia é juízo de mera admissibilidade, não exigindo certeza.

Dessa forma, as provas coligidas aos autos são cristalinas e aptas a comprovar a materialidade do delito e a existência de indícios suficientes de autoria, estando presentes os requisitos exigidos pelo artigo 413 do Código de Processo Penal para que o Acusado seja pronunciado.

Em relação às qualificadoras imputadas na denúncia, imperioso o acolhimento delas, porquanto somente é cabível a exclusão das qualificadoras, na decisão de pronúncia, quando manifestamente improcedentes e descabidas, devendo a análise ficar a cargo do Conselho de Sentença.

4 – DOS PEDIDOS
Ante o exposto, o Ministério Público requer a procedência da ação com a PRONÚNCIA do réu, nos termos expostos, para que seja submetido a julgamento pelo Tribunal do Júri e, ao final, condenado.
...
Promotor de Justiça.`
  },
  {
    id: "crime-7",
    category: "Crime",
    title: "7. Alegações Finais por Memoriais (Rito do Júri) - Exemplo Rafael",
    content: `ALEGAÇÕES FINAIS POR MEMORIAL
Meritíssimo Juiz,

I – Relatório
Rafael Menezes foi denunciado pela prática de homicídio qualificado pelo meio cruel. Encerrada a instrução, sem diligências pendentes, os debates foram convertidos em memoriais.

II – Preliminar
Inicialmente, impõe-se o enfrentamento da preliminar arguida pela defesa, que sustenta nulidade absoluta por ausência de defensor nas oitivas durante o inquérito policial. Tal arguição não merece acolhida, pois o inquérito possui natureza inquisitiva. Ademais, não houve demonstração de prejuízo.
Embora a denúncia tenha imputado apenas o meio cruel, há presença da qualificadora do recurso que dificultou a defesa da vítima, tornando cabível a sua inclusão mediante emendatio libelli. Ficou comprovado que o réu atacou a vítima repentinamente pelas costas.

III - Mérito
A materialidade delitiva está amplamente comprovada pelo laudo necroscópico e apreensão da arma. A autoria delitiva é inequivocamente atribuída a Rafael Menezes, que admitiu os golpes em juízo. A tese de legítima defesa é isolada e desmentida pelo conjunto probatório.
A dinâmica dos fatos revela execução ardilosa e previamente articulada. O ataque foi súbito e pelas costas, caracterizando a qualificadora do recurso que dificultou a defesa do ofendido. O exame necroscópico demonstrou seis golpes profundos em regiões vitais, configurando a qualificadora do meio cruel.
Presentes a prova da materialidade e os indícios suficientes de autoria, deve o acusado ser pronunciado.

IV - Conclusão
Diante do exposto, o Ministério Público requer a rejeição da preliminar de nulidade e a consequente pronúncia de Rafael Menezes como incurso nas sanções do artigo 121, parágrafo 2º, incisos III e IV, do Código Penal.
...
O MINISTÉRIO PÚBLICO DO ESTADO, pelo Promotor de Justiça em exercício, vem interpor APELAÇÃO, em face da sentença proferida nos autos da ação penal promovida contra o Réu. Oferece, desde já, as razões de inconformismo; e requer seja recebido e encaminhado o recurso ao Tribunal.

RAZÕES RECURSAIS
Egrégio Tribunal, Colenda Turma, Douta Procuradoria de Justiça.

1 – DO RELATÓRIO
Trata-se de ação penal promovida pelo Ministério Público. Encerrada a instrução, o magistrado proferiu sentença absolutória. Inconformado com a respeitável sentença, o Ministério Público interpõe o presente recurso de Apelação.

2 – DOS PRESSUPOSTOS DE ADMISSIBILIDADE RECURSAL
O recurso é cabível, tempestivo e o Ministério Público possui legitimidade recursal. Requer-se o conhecimento do presente recurso.

3 – DO MÉRITO
A materialidade delitiva restou devidamente comprovada em razão dos laudos e exames, aliados aos depoimentos colhidos na instrução criminal. Ademais, a autoria é certa e segura ante as provas carreadas nos autos. As testemunhas foram firmes em apontar o réu como autor do delito. Dessa forma, as provas são cristalinas e aptas a comprovar a responsabilidade do Acusado, devendo a sentença absolutória ser reformada. A tese defensiva acolhida pelo juízo de primeiro grau não encontra amparo no conjunto probatório.

4 – DO PREQUESTIONAMENTO
Caso não acolhidos os pedidos, fica desde já prequestionada a violação aos dispositivos legais mencionados, possibilitando que o tema seja revisitado perante os Tribunais Superiores.

5 – DOS PEDIDOS
Ante o exposto, o Ministério Público requer o conhecimento e provimento do recurso, determinando a reforma da sentença para condenar o réu nos exatos termos da denúncia.
...
Promotor de Justiça.`
  },
  {
    id: "crime-9",
    category: "Crime",
    title: "9. Recurso em Sentido Estrito (RESE)",
    content: `AO JUÍZO DA VARA CRIMINAL DA COMARCA.
Autos número.

O MINISTÉRIO PÚBLICO DO ESTADO, pelo Promotor de Justiça em exercício, vem interpor RECURSO EM SENTIDO ESTRITO, em face da decisão interlocutória proferida nos autos da ação penal. Oferece as razões de inconformismo e requer seja recebido o recurso, observada a oportunidade de retratação e, caso mantida a decisão, seja encaminhado ao Tribunal.

RAZÕES RECURSAIS
Egrégio Tribunal, Colenda Turma, Nobre Magistrado.

1 – DO RELATÓRIO
Trata-se de ação penal promovida pelo Ministério Público. O magistrado proferiu decisão rejeitando a denúncia. Inconformado, o Ministério Público interpõe o presente recurso em sentido estrito.

2 – DOS PRESSUPOSTOS DE ADMISSIBILIDADE RECURSAL
O presente recurso é cabível, tempestivo e o Ministério Público possui legitimidade. Requer-se o conhecimento do recurso.

3 – DO MÉRITO
A decisão que rejeitou a denúncia carece de fundamentação idônea. A materialidade delitiva e os indícios de autoria estão devidamente demonstrados nos autos do inquérito policial, preenchendo os requisitos exigidos pelo artigo 41 do Código de Processo Penal para o recebimento da peça acusatória. A justa causa para a ação penal é evidente, não cabendo ao juízo, nesta fase preliminar, realizar análise aprofundada do mérito que culmine na rejeição prematura da denúncia.

4 – DOS PEDIDOS
Ante o exposto, o Ministério Público requer o conhecimento e provimento do presente recurso, determinando a reforma da decisão atacada para que a denúncia seja integralmente recebida e o processo tenha seu regular prosseguimento.
...
Promotor de Justiça.`
  },
  {
    id: "crime-10",
    category: "Crime",
    title: "10. Agravo em Execução Penal",
    content: `AO JUÍZO DA VARA DE EXECUÇÕES PENAIS DA COMARCA.
Autos número.

O MINISTÉRIO PÚBLICO DO ESTADO, pelo Promotor de Justiça em exercício, vem interpor AGRAVO EM EXECUÇÃO, em face da decisão proferida nos autos da execution penal movida contra o Réu. Requer seja recebido o recurso, observada a oportunidade de retratação e, caso mantida a decisão, seja encaminhado ao Tribunal.

RAZÕES RECURSAIS
Egrégio Tribunal, Colenda Turma, Nobre Magistrado.

1 – DO RELATÓRIO
Trata-se de execução penal. O magistrado proferiu decisão concedendo a progressão de regime ao sentenciado sem a realização de exame criminológico prévio. Inconformado, o Ministério Público interpõe o presente recurso.

2 – DOS PRESSUPOSTOS DE ADMISSIBILIDADE RECURSAL
O recurso é cabível, tempestivo e o Ministério Público possui legitimidade. Requer-se o conhecimento do recurso.

3 – DO MÉRITO
A decisão agravada merece reforma. Tratando-se de sentenciado condenado por crime hediondo, com histórico de faltas disciplinares graves, a realização de exame criminológico é imprescindível para aferir o mérito do apenado e sua aptidão para retornar ao convívio social em regime menos rigoroso. A gravidade da execução exige cautela, e a ausência de avaliação técnica compromete a segurança pública e a finalidade da pena. A jurisprudência dos Tribunais Superiores admite a exigência do exame quando motivada pelas peculiaridades do caso concreto.

4 – DOS PEDIDOS
Ante o exposto, o Ministério Público requer o conhecimento e provimento do presente recurso, determinando a reforma da decisão para cassar a progressão de regime concedida, condicionando-a à prévia e favorável realização de exame criminológico.
...
Promotor de Justiça.`
  },
  {
    id: "crime-11",
    category: "Crime",
    title: "11. Contrarrazões Recursais (Apelação)",
    content: `CONTRARRAZÕES DE APELAÇÃO
EGRÉGIO TRIBUNAL, NOBRES JULGADORES, DOUTA PROCURADORIA DE JUSTIÇA.

O apelante foi condenado por estupro de vulnerável. Inconformado, interpôs apelação, sustentando nulidade pela ausência de Acordo de Não Persecução Penal e cerceamento de defesa. No mérito, pugna pela absolvição por insuficiência probatória ou desclassificação.

DA ADMISSIBILIDADE RECURSAL
O recurso interposto merece ser conhecido, porquanto preenchidos todos os requisitos de admissibilidade.

DAS PRELIMINARES
Não há nulidade pela ausência de ANPP. O tipo penal envolve violência presumida e pena mínima superior a 4 anos, tornando o instituto inaplicável. O indeferimento de acareação não configura cerceamento de defesa, sendo medida discricionária do juiz, desnecessária diante do farto conjunto probatório.

DO MÉRITO
A condenação encontra amparo em acervo probatório consistente. A materialidade restou evidenciada por laudo psicológico e depoimento especial da vítima. A autoria é insofismável. A palavra da vítima, corroborada por testemunhas, aponta o apelante como autor. Em crimes sexuais, a palavra da vítima possui especial relevância.
A pretensão de desclassificação carece de amparo. Os atos libidinosos praticados configuram de forma plena o delito de estupro de vulnerável. A continuidade delitiva foi corretamente aplicada, revelando pluralidade de condutas. A dosimetria da pena e o regime fechado foram fixados de forma justa e proporcional.

DO PEDIDO
Diante do exposto, o Ministério Público requer o conhecimento do recurso e, no mérito, o seu integral desprovimento, mantendo-se a respeitável sentença condenatória por seus próprios fundamentos.
...
Promotor de Justiça.`
  },
  {
    id: "crime-12",
    category: "Crime",
    title: "12. Contrarrazões Recursais (Recurso em Sentido Estrito)",
    content: `CONTRARRAZÕES AO RECURSO EM SENTIDO ESTRITO
EGRÉGIO TRIBUNAL DE JUSTIÇA, COLENDA CÂMARA CRIMINAL.

O MINISTÉRIO PÚBLICO vem apresentar CONTRARRAZÕES AO RECURSO EM SENTIDO ESTRITO interposto pela defesa de ALEXANDRE RAMOS.

I – BREVE SÍNTESE
O recorrente foi pronunciado por homicídio qualificado. A defesa interpôs recurso sustentando preliminares de nulidade e teses de mérito, inclusive desclassificação e revogação da prisão preventiva.

II - DA ADMISSIBILIDADE RECURSAL
O recurso merece ser conhecido, preenchidos os requisitos legais.

III – DAS PRELIMINARES
Não há nulidade por ausência de intimação pessoal sobre laudo complementar, pois a defesa constituída foi intimada via Diário da Justiça Eletrônico, não havendo demonstração de prejuízo. A negativa de oitiva de testemunhas irrelevantes foi devidamente fundamentada pelo juízo, não configurando cerceamento de defesa.

IV – DO MÉRITO
A decisão de pronúncia está alicerçada em acervo probatório consistente. A materialidade está demonstrada por laudos periciais. A autoria encontra-se delineada por depoimentos e imagens de câmeras de segurança, permitindo juízo de probabilidade qualificada para submissão ao Tribunal do Júri.
A tese de homicídio privilegiado não encontra suporte, pois o réu agiu com frieza e premeditação, incompatível com violenta emoção. A alegação de legítima defesa é isolada e dissociada das provas, não havendo agressão injusta por parte da vítima.
A manutenção da prisão preventiva é necessária pela gravidade concreta da conduta e risco à ordem pública.

V – CONCLUSÃO
O Ministério Público requer o conhecimento do recurso e seu integral desprovimento, mantendo-se a decisão de pronúncia e a prisão preventiva do recorrente.
...
Promotor de Justiça.`
  },
  {
    id: "crime-13",
    category: "Crime",
    title: "13. Contrarrazões Recursais (Agravo em Execução)",
    content: `CONTRARRAZÕES AO AGRAVO EM EXECUÇÃO
EGRÉGIO TRIBUNAL DE JUSTIÇA, COLENDA CÂMARA CRIMINAL.

I – SÍNTESE DO CASO
O agravante cumpre pena em regime fechado. O juízo determinou a coleta de material genético e a exigência de exame criminológico para progressão. A defesa interpôs agravo alegando afronta à vedação à autoincriminação e retroatividade indevida da lei.

II – DA ADMISSIBILIDADE RECURSAL
O agravo deve ser conhecido, pois presentes os requisitos de admissibilidade.

III – DA LEGITIMIDADE DA COLETA DO PERFIL GENÉTICO
A coleta de material genético não viola a intimidade ou a não autoincriminação. Trata-se de técnica de identificação não invasiva, com escopo registral e estatístico para auxiliar a segurança pública, em consonância com a jurisprudência do Superior Tribunal de Justiça e a Constituição Federal.

IV – DA EXIGÊNCIA DE EXAME CRIMINOLÓGICO
A exigência de exame criminológico decorreu de decisão judicial fundamentada nas peculiaridades do caso, como a reincidência e oscilações no comportamento carcerário, compatível com a Súmula 439 do STJ. Não houve aplicação retroativa de lei mais gravosa, mas sim avaliação concreta da necessidade da medida para aferir o mérito do apenado.

V – CONCLUSÃO
Diante do exposto, o Ministério Público requer o conhecimento do agravo em execução e seu integral desprovimento, mantendo-se as decisões proferidas pelo Juízo da Execução quanto à legalidade da coleta do perfil genético e à exigência do exame criminológico.
...
Promotor de Justiça.`
  },
  {
    id: "crime-14",
    category: "Crime",
    title: "14. Modelo - Cota Ministerial - 2",
    content: `COTA DE OFERECIMENTO DA DENÚNCIA Autos de Inquérito Policial n.º... MM. Juiz,
Oferecida denúncia em separado;
Requer-se remessa para o juízo competente (art.3-B, XIV c/c art. 3ª-C do CPP, com interpretação conforme pelo STF)
Requer-se a juntada de folha de antecedentes criminais e certidões;
